...
character_size = character.get_rect().size  # 케릭터 이미지 크기 구해옴
...
enemy = pygame.image.load(
    "C:/Users/lgylg/Desktop/nadocoding/nano_python_2/pygame_basic/enemy.png")
enemy_size = enemy.get_rect().size  # 케릭터 이미지 크기 구해옴
...
# 화면 세로 크기의 가장 아래에 해당하는 곳에 위치(세로)
enemy_y_pos = (screen_heigth/2)-(enemy_height/2)
