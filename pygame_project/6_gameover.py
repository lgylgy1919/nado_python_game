...
stage_height = stage_size[1]  # 스테이지의 높이 위체 캐릭터를 두기 위해 사용
...
# 공 크기에 다른 최초 스피드
ball_speed_y = [-18, -15, -12, -9]  # iindex 0, 1, 2, 3 에 해당하는 값
...
while running:
    ...
    for ball_idx, ball_val in enumerate(balls):
        ...
        break  # 안쪽 for 문에서 break를 만나면 여기로 진이 가능. 2중 for문  한번에 나감
